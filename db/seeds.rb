...
Inventory.create([
    {category: "Beer", qty: 100, name: "COORS Light 30 Rack", price_per_item: 26, total_cost: 1400, user_id: 1},
    ...
    {category: "Gin", qty: 25, name: "Tanqueray London Dry Gin", price_per_item: 16, total_cost: 250, user_id: 1},
    {category: "Gin", qty: 35, name: "Hendrick's", price_per_item: 19, total_cost: 480, user_id: 1},
    {category: "Gin", qty: 21, name: "Aviation", price_per_item: 13, total_cost: 110, user_id: 1},
    {category: "Gin", qty: 55, name: "The Botanist Islay Dry Gin", price_per_item: 25, total_cost: 960, user_id: 1},
    {category: "Gin", qty: 150, name: "Roku", price_per_item: 10, total_cost: 1100, user_id: 1},
    {category: "Gin", qty: 200, name: "Monkey 47", price_per_item: 20, total_cost: 2500, user_id: 1},
    {category: "Gin", qty: 250, name: "Fords", price_per_item: 15, total_cost: 2100, user_id: 1},

    {category: "Brandy", qty: 25, name: "Hennessy", price_per_item: 40, total_cost: 650, user_id: 1},
    {category: "Brandy", qty: 35, name: "E&J", price_per_item: 29, total_cost: 700, user_id: 1},
    {category: "Brandy", qty: 21, name: "D'USSE Cognac", price_per_item: 16, total_cost: 160, user_id: 1},
    {category: "Brandy", qty: 55, name: "Paul Masson Grande", price_per_item: 40, total_cost: 1327, user_id: 1},
    {category: "Brandy", qty: 150, name: "Salignac Cognac", price_per_item: 16, total_cost: 1433, user_id: 1},
    {category: "Brandy", qty: 200, name: "St-Remy VSOP", price_per_item: 20, total_cost: 1671, user_id: 1},
    {category: "Brandy", qty: 250, name: "CIROC VS Brandy", price_per_item: 26, total_cost: 3989, user_id: 1},

    {category: "Whiskey", qty: 25, name: "Jim Beam", price_per_item: 20, total_cost: 350, user_id: 1},
    {category: "Whiskey", qty: 35, name: "Crown Royal", price_per_item: 29, total_cost: 700, user_id: 1},
    {category: "Whiskey", qty: 21, name: "Jack Daniel's", price_per_item: 18, total_cost: 150, user_id: 1},
    {category: "Whiskey", qty: 55, name: "Four Roses", price_per_item: 15, total_cost: 501, user_id: 1},
    {category: "Whiskey", qty: 150, name: "Johnnie Walker Red Label", price_per_item: 34, total_cost: 2461, user_id: 1},
    {category: "Whiskey", qty: 200, name: "Wild Turkey 101", price_per_item: 9, total_cost: 1000, user_id: 1},
    {category: "Whiskey", qty: 50, name: "High West Double Rye", price_per_item: 23, total_cost: 672, user_id: 1},

    {category: "Rum", qty: 35, name: "Captain Morgan Original", price_per_item: 20, total_cost: 350, user_id: 1},
    {category: "Rum", qty: 65, name: "Barcardi White", price_per_item: 16, total_cost: 611, user_id: 1},
    {category: "Rum", qty: 35, name: "Barcardi Gold", price_per_item: 16, total_cost: 232, user_id: 1},
    {category: "Rum", qty: 42, name: "The Kraken Black", price_per_item: 13, total_cost: 212, user_id: 1},
    {category: "Rum", qty: 150, name: "Malibu Pineapple", price_per_item: 10, total_cost: 1001, user_id: 1},
    {category: "Rum", qty: 80, name: "Brugal Anejo", price_per_item: 40, total_cost: 1356, user_id: 1},
    {category: "Rum", qty: 50, name: "Don Q Rum", price_per_item: 23, total_cost: 672, user_id: 1},

    {category: "Tequila", qty: 35, name: "Patron Silver", price_per_item: 50, total_cost: 850, user_id: 1},
    {category: "Tequila", qty: 65, name: "Patron White", price_per_item: 49, total_cost: 1800, user_id: 1},
    {category: "Tequila", qty: 33, name: "Don Julio Blanco", price_per_item: 16, total_cost: 300, user_id: 1},
    {category: "Tequila", qty: 42, name: "1800 Silver", price_per_item: 16, total_cost: 450, user_id: 1},
    {category: "Tequila", qty: 150, name: "Sauza Silver", price_per_item: 10, total_cost: 900, user_id: 1},
    {category: "Tequila", qty: 80, name: "Tequila Rose", price_per_item: 15, total_cost: 950, user_id: 1},
    {category: "Tequila", qty: 20, name: "Hornitos Anejo", price_per_item: 19, total_cost: 215, user_id: 1},

    {category: "Everclear", qty: 20, name: "Everclear 190 Proof", price_per_item: 40, total_cost: 500, user_id: 1},
    {category: "Everclear", qty: 20, name: "Everclear 120 Proof", price_per_item: 25, total_cost: 250, user_id: 1},

    {category: "Absinthe", qty: 33, name: "St George", price_per_item: 50, total_cost: 1000, user_id: 1},
    {category: "Absinthe", qty: 42, name: "Lucid", price_per_item: 40, total_cost: 921, user_id: 1},
    {category: "Absinthe", qty: 20, name: "Mata Hari", price_per_item: 25, total_cost: 265, user_id: 1},
    {category: "Absinthe", qty: 25, name: "Vieux Carre", price_per_item: 30, total_cost: 950, user_id: 1},
    {category: "Absinthe", qty: 10, name: "La Muse Verte Pastis", price_per_item: 37, total_cost: 175, user_id: 1},
